...
class UpdateFixedAssetRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        $assetId = $this->route('fixed_asset')?->id;
        ...
        return [
            ...
            'code' => [
                ...
                'string',
                'max:20',
                Rule::unique('fixed_assets')->where('tenant_id', $tenantId)->ignore($assetId),
            ],
            ...
            'useful_life_years' => ['sometimes', 'required', 'numeric', 'min:0.5'],
            'salvage_value' => ['nullable', 'numeric', 'min:0'],
            'depreciation_start_date' => ['sometimes', 'required', 'date', 'after_or_equal:acquisition_date'],
